...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      seg_acidentes: {
        Row: { id: string; tenant_id: string; unit_id: string | null; occurred_on: string; occurred_at: string | null; turno: string | null; classe: Database["public"]["Enums"]["seg_acidente_class"]; tipo: Database["public"]["Enums"]["seg_acidente_tipo"]; status: Database["public"]["Enums"]["seg_acidente_status"]; user_id: string; snap_full_name: string | null; snap_employee_code: string | null; snap_department_id: string | null; snap_department_name: string | null; snap_subdepartment_id: string | null; snap_subdepartment_name: string | null; snap_position_id: string | null; snap_position_name: string | null; snap_manager_id: string | null; snap_manager_name: string | null; snap_unit_id: string | null; snap_unit_name: string | null; local_id: string | null; area_id: string | null; descricao: string; testemunhas: string | null; parte_corpo: string | null; agente_causador: string | null; natureza_lesao: string | null; analise_causa: string | null; causa_id: string | null; cat_numero: string | null; cat_emitida_em: string | null; cid_code: string | null; cid_descricao: string | null; dias_afastamento: number | null; afastamento_de: string | null; retorno_em: string | null; encerrado_por: string | null; encerrado_em: string | null; houve_perdas: boolean; perdas_descricao: string | null; perdas_valor: number | null; motivo_exclusao: string | null; created_by: string; created_at: string; updated_at: string }
        Insert: { id?: string; tenant_id: string; unit_id?: string | null; occurred_on: string; occurred_at?: string | null; turno?: string | null; classe: Database["public"]["Enums"]["seg_acidente_class"]; tipo?: Database["public"]["Enums"]["seg_acidente_tipo"]; user_id: string; local_id?: string | null; area_id?: string | null; descricao: string; testemunhas?: string | null; parte_corpo?: string | null; agente_causador?: string | null; natureza_lesao?: string | null; analise_causa?: string | null; causa_id?: string | null; cat_numero?: string | null; cat_emitida_em?: string | null; cid_code?: string | null; cid_descricao?: string | null; dias_afastamento?: number | null; afastamento_de?: string | null; retorno_em?: string | null; houve_perdas?: boolean; perdas_descricao?: string | null; perdas_valor?: number | null; created_by?: string }
        Update: { unit_id?: string | null; occurred_on?: string; occurred_at?: string | null; turno?: string | null; classe?: Database["public"]["Enums"]["seg_acidente_class"]; tipo?: Database["public"]["Enums"]["seg_acidente_tipo"]; local_id?: string | null; area_id?: string | null; descricao?: string; testemunhas?: string | null; parte_corpo?: string | null; agente_causador?: string | null; natureza_lesao?: string | null; analise_causa?: string | null; causa_id?: string | null; cat_numero?: string | null; cat_emitida_em?: string | null; cid_code?: string | null; cid_descricao?: string | null; dias_afastamento?: number | null; afastamento_de?: string | null; retorno_em?: string | null; houve_perdas?: boolean; perdas_descricao?: string | null; perdas_valor?: number | null }
        Relationships: []
      }
      seg_acidente_anexos: {
