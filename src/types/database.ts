  ...
  public: {
    Tables: {
      ...
      absenteismo_atestados: {
        Row: { lancamento_id: string; tenant_id: string; cid_code: string | null; cid_description: string | null; doctor_name: string | null; doctor_crm: string | null; facility: string | null; issued_on: string | null; days_off: number | null; companion_name: string | null; hours_start: string | null; hours_end: string | null; updated_by: string | null; created_at: string; updated_at: string }
        Insert: { lancamento_id: string; tenant_id: string; cid_code?: string | null; cid_description?: string | null; doctor_name?: string | null; doctor_crm?: string | null; facility?: string | null; issued_on?: string | null; days_off?: number | null; companion_name?: string | null; hours_start?: string | null; hours_end?: string | null; updated_by?: string | null; created_at?: string; updated_at?: string }
        Update: { lancamento_id?: string; tenant_id?: string; cid_code?: string | null; cid_description?: string | null; doctor_name?: string | null; doctor_crm?: string | null; facility?: string | null; issued_on?: string | null; days_off?: number | null; companion_name?: string | null; hours_start?: string | null; hours_end?: string | null; updated_by?: string | null; created_at?: string; updated_at?: string }
        Relationships: []
      }
